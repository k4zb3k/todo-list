...
func init() {
	...
	err := os.MkdirAll("/home/k4zb3k/Desktop/todo/logs", 0777)
	if err != nil {
		log.Println(err)
	}

	allFile, err := os.OpenFile("/home/k4zb3k/Desktop/todo/logs/all.logs", os.O_CREATE|os.O_WRONLY|os.O_APPEND, 0777)
	if err != nil {
		log.Println(err)
	}
